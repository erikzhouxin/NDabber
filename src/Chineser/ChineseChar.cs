...
namespace System.Data.Chineser
{
    ...
    public class ChineseChar
    {
        ...
        private static PinYinConverter.CharDictionary charDictionary;

        private static PinYinConverter.PinyinDictionary pinyinDictionary;

        private static PinYinConverter.StrokeDictionary strokeDictionary;

        private static PinYinConverter.HomophoneDictionary homophoneDictionary;
        ...
        public ChineseChar(char ch)
        {
            ...
            {
                throw new NotSupportedException(PinYinConverter.CHARACTER_NOT_SUPPORTED);
            }
            this.chineseCharacter = ch;
            var charUnit = ChineseChar.charDictionary.GetCharUnit(ch);
            ...
            {
                var pinYinUnitByIndex = ChineseChar.pinyinDictionary.GetPinYinUnitByIndex((int)charUnit.PinyinIndexList[i]);
        ...
        {
            var charUnit = ChineseChar.charDictionary.GetCharUnit(ch1);
            var charUnit2 = ChineseChar.charDictionary.GetCharUnit(ch2);
        ...
        public static char[] GetChars(string pinyin)
        {
            ...
            var homophoneUnit = ChineseChar.homophoneDictionary.GetHomophoneUnit(ChineseChar.pinyinDictionary, pinyin);
        ...
        public static bool IsValidStrokeNumber(short strokeNumber)
        {
            ...
            var strokeUnit = ChineseChar.strokeDictionary.GetStrokeUnit((int)strokeNumber);
