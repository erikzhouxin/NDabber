...
namespace System.Data.DabberUT.CheckerUT
{
    ...
    public class CyptoUT
    {
        ...
        public void MyTestMethod232()
        {
            ...
            Console.WriteLine(UserCrypto.GetAesDecrypt(str, "Qmsttwl" + UserPassword.DefaultPasswordB));
        }
        [TestMethod]
        public void TestPxDb()
        {
            Console.WriteLine("==302=".GetDebase64());
        }
        [TestMethod]
        public void TestDecrypto()
        {
            var text = "";
            Console.WriteLine(UserCrypto.GetAesDecrypt( text,"Lngzms"+UserPassword.DefaultPasswordB));
        }
    }
}
